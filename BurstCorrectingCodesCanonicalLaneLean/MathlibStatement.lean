import hautevilleHouse.BurstCorrectingCodesCanonicalLaneLean.FinalTheorem
...
def mathlibProofObligation : MathlibProofObligation := {
  sourceKey := "burst-correcting-codes-canonical-lane"
  theoremObject := "ConstrainedBurstCodeClosure"
...
def theoremSpecificEndgamePilotClosed : Prop :=
  ∀ A : AdmissibleClass, ConstrainedBurstCodeClosure A

theorem theorem_specific_endgame_pilot_checked :
    theoremSpecificEndgamePilotClosed := by
  intro A
  exact constrained_burst_code_endgame A
